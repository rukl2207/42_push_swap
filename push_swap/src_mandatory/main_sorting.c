...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/19 13:47:49 by scornhol          #+#    #+#             */
...
void	ft_sorting_5(t_stack_list **stack1, t_stack_list **stack2, int count)
{
	if (check_sort_list(stack1, count) != 1)
	{
...
void	main_sorting(t_stack_list **stack1, int count, int *arr_int)
{
	...
	if (count == 2)
		...
		ft_sorting_5(stack1, &stack2, count);
	else if (count > 5)
